(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))l(e);new MutationObserver(e=>{for(const n of e)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&l(r)}).observe(document,{childList:!0,subtree:!0});function i(e){const n={};return e.integrity&&(n.integrity=e.integrity),e.referrerPolicy&&(n.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?n.credentials="include":e.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function l(e){if(e.ep)return;e.ep=!0;const n=i(e);fetch(e.href,n)}})();const m=[{id:1,codigo:987654,fecha:"30/11/2023",aula:"A4",grupo:"ESO1",ordenador:"PC7",descripcion:"Problema de impresión",alumno:"José Rodríguez",estado:0},{id:2,codigo:987655,fecha:"01/12/2023",aula:"B2",grupo:"BACH2",ordenador:"PC2",descripcion:"Fallo en la conexión USB",alumno:"María Sánchez",estado:0},{id:3,codigo:987656,fecha:"02/12/2023",aula:"C1",grupo:"BACH1",ordenador:"PC5",descripcion:"Pérdida de datos en la aplicación",alumno:"Antonio López",estado:0},{id:4,codigo:987657,fecha:"03/12/2023",aula:"A4",grupo:"ESO2",ordenador:"PC1",descripcion:"Problema con el teclado",alumno:"Isabel Martínez",estado:0},{id:5,codigo:987658,fecha:"04/12/2023",aula:"B3",grupo:"BACH3",ordenador:"PC4",descripcion:"Error en la conexión a la impresora",alumno:"Francisco García",estado:0},{id:6,codigo:845672,fecha:"25/06/2023",fecharesuelto:"22/07/2023",aula:"B3",grupo:"BACH3",ordenador:"PC5",descripcion:"Problema de software",alumno:"Elena Fernández",estado:1},{id:7,codigo:845673,fecha:"26/06/2023",fecharesuelto:"23/07/2023",aula:"A4",grupo:"ESO2",ordenador:"PC4",descripcion:"No se puede acceder a la red interna",alumno:"Carlos Martínez",estado:1},{id:8,codigo:845674,fecha:"27/06/2023",fecharesuelto:"24/07/2023",aula:"C1",grupo:"BACH1",ordenador:"PC6",descripcion:"Problema con el mouse",alumno:"Laura Sánchez",estado:1},{id:9,codigo:845675,fecha:"28/06/2023",fecharesuelto:"25/07/2023",aula:"B2",grupo:"BACH2",ordenador:"PC3",descripcion:"No se puede imprimir en color",alumno:"Miguel Torres",estado:1},{id:10,codigo:845676,fecha:"29/06/2023",fecharesuelto:"26/07/2023",aula:"T6",grupo:"DAW1",ordenador:"PC7",descripcion:"Problema con la tarjeta gráfica",alumno:"Carmen García",estado:1}],$=[{id:0,autor:"Carlos",fecha:"13/11/2023",comentario:"Muy buena película"},{id:1,autor:"Ana",fecha:"15/11/2023",comentario:"Interesante artículo, gracias por compartir."},{id:2,autor:"David",fecha:"20/11/2023",comentario:"Me encantó el concierto, la banda estuvo genial."},{id:3,autor:"María",fecha:"25/11/2023",comentario:"El libro me pareció fascinante, no pude soltarlo hasta terminarlo."}],C=(a,o,i)=>`
    ...
    `,script:()=>{q.script(),document.querySelector("#btnAñadir").addEventListener("click",a=>{a.preventDefault();const o=document.querySelector("#comentario").value,i=document.querySelector("#hora").value;document.querySelector("#nombre").value;const l=i.split("T")[0].split("-"),e=`${l[2]}/${l[1]}/${l[0]}`,n=document.querySelector("#correo").textContent;let r=localStorage.getItem("usuarios");r=JSON.parse(r);const s={autor:r.find(t=>t.mail===n).nombre,fecha:e,comentario:o};$.push(s),q.script()}),document.querySelector("#btnVolver").addEventListener("click",a=>{a.preventDefault(),document.querySelector("main").innerHTML=u.template,u.script()})}};let f=m;function A(a,o,i){const e=a.target.closest(".ticket").dataset.ticketid;let n=f.filter(t=>t.id!=e&&t.estado==0),r=f.filter(t=>t.id==e||t.estado==1),c="",s="";n.forEach(t=>{c+=`
        ...
        `}),r.forEach(t=>{if(!t.fecharesuelto){const p=new Date,d=p.getDate(),g=p.getMonth()+1,v=p.getFullYear(),y=`${d.toString().padStart(2,"0")}/${g.toString().padStart(2,"0")}/${v}`;t.fecharesuelto=y,t.estado=1}s+=`
            <tr data-ticketid=${t.id} class="ticket">
                <td>${t.codigo}</td>
                <td>${t.fecha}</td>
        ...
        `}),console.log(c),console.log(s),o.innerHTML=c,i.innerHTML=s,f=[...n,...r]}function I(){document.querySelector("main").innerHTML=k.template,k.script()}function M(a,o,i){const e=a.target.closest(".ticket").dataset.ticketid;let n=f.filter(t=>t.id!=e&&t.estado==0),r=f.filter(t=>t.id!=e&&t.estado==1),c="",s="";n.forEach(t=>{c+=`
            <tr data-ticketid=${t.id} class="ticket">
                <td>${t.codigo}</td>
                <td>${t.fecha}</td>
                <td>${t.aula}</td>
        ...
        `}),o.innerHTML=c,i.innerHTML=s,f=[...n,...r]}function H(a){let i=a.target.closest(".ticket").dataset.ticketid;const l=m.find(n=>n.id==i);let e=document.querySelector("#exampleModal");e.classList.add("show"),e.style.display="block",l&&(l.fecha=l.fecha.split("/"),l.fecha=l.fecha[2]+"-"+l.fecha[1]+"-"+l.fecha[0],console.log("ticketSeleccionado.fecha",l.fecha),document.querySelector("#codigo").value=l.codigo,document.querySelector("#fecha").value=l.fecha,document.querySelector("#aula").value=l.aula,document.querySelector("#ordenador").value=l.ordenador,document.querySelector("#descripcion").value=l.descripcion,document.querySelector("#alumno").value=l.alumno,document.querySelector("#grupo").value=l.grupo),document.getElementById("btnEditarTicket").addEventListener("click",n=>{n.preventDefault();var r=document.querySelector("#fecha").value,c=r.split("-"),s=c[2]+"/"+c[1]+"/"+c[0];const t=parseInt(document.querySelector("#codigo").value),p=document.querySelector("#aula").value,d=document.querySelector("#ordenador").value,g=document.querySelector("#descripcion").value,v=document.querySelector("#alumno").value,y=document.querySelector("#grupo").value,S=m.findIndex(x=>x.id==i);S!=-1?(m[S]={id:i,codigo:t,fecha:s,aula:p,ordenador:d,descripcion:g,alumno:v,grupo:y,estado:m[S].estado},document.querySelector("#pendientes").innerHTML="",u.script()):console.error("Ticket no encontrado en la base de datos");let E=document.querySelector("#exampleModal");E.classList.remove("show"),E.style.display="none"}),document.querySelector("#btnCerrar").addEventListener("click",n=>{let r=document.querySelector("#exampleModal");r.classList.add("show"),r.style.display="none"})}const L={template:`
    ...
    `,script:()=>{document.getElementById("btnAñadirTicket").addEventListener("click",a=>{a.preventDefault();const o=parseInt(document.getElementById("codigo").value),i=document.getElementById("aula").value,l=document.getElementById("ordenador").value,e=document.getElementById("descripcion").value,n=document.getElementById("alumno").value,r=document.getElementById("grupo").value;var c=document.querySelector("#fecha").value,s=c.split("-"),t=s[2]+"/"+s[1]+"/"+s[0];const d={id:(m.length>0?m[m.length-1].id:0)+1,codigo:o,fecha:t,aula:i,grupo:r,ordenador:l,descripcion:e,alumno:n,estado:0};m.push(d),document.querySelector("main").innerHTML=u.template,u.script()}),document.getElementById("btnSalir").addEventListener("click",a=>{a.preventDefault(),document.querySelector("main").innerHTML=u.template,u.script()})}},u={template:`
    ...
    `,script:()=>{document.querySelector("#login").classList.add("d-none"),document.querySelector("#registro").classList.add("d-none"),document.querySelector("#sesion").classList.remove("d-none");let a=document.querySelector("#pendientes"),o=document.querySelector("#resueltos"),i="",l="";m.forEach(e=>{e.estado==0?(i=`
          ...
          `,document.querySelector("#pendientes").innerHTML+=i):(l=`
            ...
            `,document.querySelector("#resueltos").innerHTML+=l)}),document.querySelector("#sesion").addEventListener("click",e=>{e.preventDefault(),document.querySelector("#correo").innerHTML="",document.querySelector("#sesion").classList.add("d-none"),document.querySelector("#login").classList.remove("d-none"),document.querySelector("#registro").classList.remove("d-none"),document.querySelector("main").innerHTML=b.template,b.script()}),document.querySelector("body").addEventListener("click",e=>{const n=document.querySelector("#correo").textContent;let r=localStorage.getItem("usuarios");r=JSON.parse(r);const c=r.find(s=>s.mail===n);c.rol==0&&(document.querySelector("#pendientesH2").classList.contains("d-none")||document.querySelector("#pendientesH2").classList.add("d-none"),document.querySelector("#pendientesTable").classList.contains("d-none")||document.querySelector("#pendientesTable").classList.add("d-none"),document.querySelector("#resueltosH2").classList.contains("d-none")||document.querySelector("#resueltosH2").classList.add("d-none"),document.querySelector("#resueltosTable").classList.contains("d-none")||document.querySelector("#resueltosTable").classList.add("d-none")),c.rol==1&&(document.querySelectorAll("#btnEliminar").forEach(function(d){d.classList.contains("d-none")||d.classList.add("d-none")}),document.querySelectorAll("#btnResolver").forEach(function(d){d.classList.contains("d-none")||d.classList.add("d-none")}),document.querySelectorAll("#btnEdit").forEach(function(d){d.classList.contains("d-none")||d.classList.add("d-none")})),c.rol==2&&(e.target.id=="btnResolver"&&(console.log("completar",e.target.id),A(e,a,o)),e.target.id=="btnEdit"&&(console.log("editar",e.target.id),H(e)),e.target.id=="btnEliminar"&&(console.log("borrar",e.target.id),M(e,a,o))),(c.rol==2||c.rol==1)&&e.target.id=="btnComment"&&(console.log("completar",e.target.id),I()),e.target.id=="btnAñadirTicket"&&(document.querySelector("main").innerHTML=L.template,L.script())})}},h={template:`
    ...
    `,script:()=>{let a=[];localStorage.setItem("usuarios",JSON.stringify(a)),a=localStorage.getItem("usuarios"),a?a=JSON.parse(a):a=[],localStorage.setItem("usuarios",JSON.stringify(a));for(let o=0;o<a.length;o++)a[o].log==1&&(document.querySelector("main").innerHTML=u.template,document.querySelector("#correo").innerHTML=a[o].mail,u.script());document.querySelector("#login").addEventListener("click",()=>{document.querySelector("main").innerHTML=b.template,b.script()}),document.querySelector("#registro").addEventListener("click",()=>{document.querySelector("main").innerHTML=h.template,h.script()})}};document.querySelector("header").innerHTML=T.template;T.script();
